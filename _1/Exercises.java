...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        if (ourSet.containsAll(Set.of(5, 2, 1))) { //ho modificato questa linea
    ...
    private static void exercise2() {
        ...
        //2a. What will this output? [Write your guesses in here] Output sarà la lista dei vari frutti all'interno del set
        ...
        //2b. What will this output? [Write your guesses in here] Output sarà l'insieme dei vari frutti contenuti in fruitSet
        // più i due elementi aggiunti con fruitList, escludendo i doppioni
        System.out.println(fruitsSet);
    }
    ...
    private static void exercise3() {
        ...
        if (max != 10 || min != 1) {
            System.out.println("Incorrect min or max values");
        } else {
        ...
        if (!itemsContainedInBothSets.equals(Set.of(5, 6, 7, 8, 9, 10))) {
            ...
            System.out.println("3b. Correct number of items in itemsContainedInBothSets"+itemsContainedInBothSets);
        }
    }
